...
<div id="main">
    ...
    <div class="row">	
        ...
        <div class="panel panel-gradient-orange panel-shadow">
            <div class="media">
    ...
    <a href="{{ URL::to('admin/properties') }}" style="text-decoration: none;">
        <div class="col-sm-6 col-md-3">
        <div class="panel panel-gradient-teal panel-shadow">
            <div class="media">
                <div class="media-left">
                    <div class="panel-body">
                        <div class="width-100">
    ...
    <a href="{{ URL::to('admin/featuredproperties') }}" style="text-decoration: none;">
    	<div class="col-sm-6 col-md-3">
        <div class="panel panel-gradient-green panel-shadow" >
            <div class="media">
                <div class="media-left">
                    <div class="panel-body">
                        <div class="width-100">
    ...
    <a href="{{ URL::to('admin/inquiries') }}" style="text-decoration: none;">
    	<div class="col-sm-6 col-md-3">
        <div class="panel panel-gradient-purple panel-shadow" style="background-color: #343a40 !important;border-color:#343a40;">
            <div class="media">
                <div class="media-left">
                    <div class="panel-body ">
                        <div class="width-100">
    ...
    <a href="{{ URL::to('admin/users') }}" style="text-decoration: none;">
    	<div class="col-sm-6 col-md-3">
        <div class="panel panel-gradient-pink panel-shadow">
            <div class="media">
                <div class="media-left">
                    <div class="panel-body">
                        <div class="width-100">
    ...
    <a href="{{ URL::to('admin/testimonials') }}" style="text-decoration: none;">
    	<div class="col-sm-6 col-md-3">
        <div class="panel panel-shadow panel-gradient-blue">
            <div class="media">
                <div class="media-left">
                    <div class="panel-body">
                        <div class="width-100">
    ...
    <a href="{{ URL::to('admin/subscriber') }}" style="text-decoration: none;">
    	<div class="col-sm-6 col-md-3">
        <div class="panel panel-default panel-gradient-purple panel-shadow">
            <div class="media">
                <div class="media-left">
                    <div class="panel-body">
                        <div class="width-100">
    ...
    <a href="{{ URL::to('admin/transactions') }}" style="text-decoration: none;">
        <div class="col-sm-6 col-md-3">
        <div class="panel panel-gradient-orange panel-shadow" style="background-color: #4a59b4 !important">
            <div class="media">
                <div class="media-left">
                    <div class="panel-body">
                        <div class="width-150">
    ...
    <a href="{{ URL::to('admin/transactions') }}" style="text-decoration: none;">
        <div class="col-sm-6 col-md-3">
        <div class="panel panel-gradient-orange panel-shadow" style="background-color: #0eac5c !important">
            <div class="media">
                <div class="media-left">
                    <div class="panel-body">
                        <div class="width-150">
