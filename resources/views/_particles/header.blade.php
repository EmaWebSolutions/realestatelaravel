<header id="main-header">
    ...
    <div class="main-header-cont container">
      ...
      <a href="{{ URL::to('/') }}">@if(getcong('site_logo')) <img src="{{ URL::asset('upload/'.getcong('site_logo')) }}" alt="{{getcong('site_name')}}" width="80" height="50"> @else <span>{{getcong('site_name')}}</span> @endif</a>
