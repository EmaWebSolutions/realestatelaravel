          ...
          <div class="box">
            ...
            switch ($step) {
              default: ?>
                ...
                if(phpversion() < "7.3"){
                  $errors = true;
                  echo "<div class='notification is-danger' style='padding:12px;'><i class='fa fa-times'></i> Current PHP version is ".phpversion()."! minimum PHP 7.3 or higher required.</div>";
                }else{
                    ...
                    if($activate_response['status'] != true){ ?>
                      <form action="index.php?step=0" method="POST">
                        ...
                        <div class="field">
                          ...
                          <p class="control-label-help">(<a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code" target="_blank">Where Is My Purchase Code?</a>)</p></label>
                          <div class="control">
                            <input class="input" type="text" placeholder="enter your purchase/license code" name="license" required>
                          </div>
                        </div>
                        <div class="field">
                          <label class="label">Envato username<p class="control-label-help">https://codecanyon.net/user/<u style="color: #e91e63">scriptscode7</u></p>
                              <p class="control-label-help">(<u style="color: #e91e63">scriptscode7</u> is username)</p></label>
                          <div class="control">
...
APP_ENV=production
APP_KEY=base64:2ai+LeXUTM9esdlfbT3UhyQkM/JBsD6G4g/AnGAk4rQ=
APP_DEBUG=false
...
STRIPE_SECRET=";
            ...
            case "2": ?>
              ...
              if($_POST && isset($_POST["dbscs"])){
                ...
                <center>
                  ...
                  <br>
                  <p>You can now login using your email: <strong>admin@gmail.com</strong> and default password: <strong>admin</strong></p><br><strong>
  ...
  <div class="content has-text-centered">
    <p>Copyright <?php echo date('Y'); ?> Scriptscode7.com, All rights reserved.</p><br>
  </div>
</body>
</html>
