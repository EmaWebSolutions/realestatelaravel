...
class Properties extends Model
{
    ...
    protected $fillable = ['user_id', 'featured_property', 'property_name','property_type','property_purpose','sale_price','rent_price','address','map_latitude','map_longitude','bathrooms','bedrooms','area','description','featured_image', 'status'];
