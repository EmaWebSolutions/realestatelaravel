...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
	...
	Route::get('properties', 'PropertiesController@propertieslist')->name('properties.index');
	...
	Route::post('properties/status/{id}', 'PropertiesController@status')->name('properties.status');	
	Route::post('properties/featuredproperty/{id}', 'PropertiesController@featuredproperty');	
...
Route::post('/payment/stripe', 'StripeController@postPaymentWithStripe')->name('postPaymentWithStripe');
